...
s = eye(size(info, 1)); % 2 Slack Variables due to the problem
...
simplTable.Properties.VariableNames = {'x_1', 'x_2', 's_1', 's_2', 'sol'}
...
while RUN
    ...
    current_BFS.Properties.VariableNames = {'x_1', 'x_2', 's_1', 's_2', 'sol'}
end